...
module.exports.createRide = async (req, res) => {
    ...
    try {
        ...
        let captainsInRadius = await mapService.getCaptainsInTheRadius(pickupCoordinates.ltd, pickupCoordinates.lng, 50);
...
module.exports.getCaptainEarnings = async (req, res) => {
    try {
        ...
        return res.status(200).json({ totalEarnings, totalRides: rides.length });
    } catch (err) {
        return res.status(500).json({ message: err.message });
    }
}